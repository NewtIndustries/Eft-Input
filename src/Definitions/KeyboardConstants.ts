...
export namespace KeyboardConstants {
	...
	export var KEYBOARD_PUSH_A = new GlobalEvent.EFTEVENT.EventBuilder(GlobalEvent.EFTEVENT.KEYBOARD).Add(GlobalEvent.EFTEVENT.KEYBORDEVENT.KEYUP).Add(Key.A).toString();
}
